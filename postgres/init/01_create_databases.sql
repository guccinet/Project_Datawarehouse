...
-- Grant privileges
GRANT ALL PRIVILEGES ON DATABASE airflow_meta TO piwat;
GRANT ALL PRIVILEGES ON DATABASE superset_meta TO piwat;
GRANT ALL PRIVILEGES ON DATABASE metastore TO piwat;
