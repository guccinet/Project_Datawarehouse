...
def main():
    ...
    if args.use_running_credentials:
        for container, mapping in [
            ('piwat-postgres', {'POSTGRES_USER': 'POSTGRES_USER', 'POSTGRES_PASSWORD': 'POSTGRES_PASSWORD', 'POSTGRES_DB': 'POSTGRES_DB'}),
            ('piwat-lakehouse-minio', {'MINIO_ROOT_USER': 'LAKEHOUSE_MINIO_USER', 'MINIO_ROOT_PASSWORD': 'LAKEHOUSE_MINIO_PASSWORD'})]:
