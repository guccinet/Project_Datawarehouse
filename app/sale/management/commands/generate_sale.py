...
CITIES = [
    "กรุงเทพมหานคร", "นนทบุรี", "สมุทรปราการ", "ปทุมธานี", "ชลบุรี", 
    "เชียงใหม่", "ขอนแก่น", "ภูเก็ต", "สงขลา", "นครราชสีมา", "พระนครศรีอยุธยา"
]

CARRIERS = ["Flash Express", "Kerry Express", "Thailand Post (EMS)", "J&T Express", "Shopee Xpress", "DHL eCommerce"]
...
def random_email(name):
    ...
    domains = ["gmail.com", "hotmail.com", "outlook.com", "yahoo.com", "piwat.co.th"]
